...
H_vals = linspace(0, 3, 5000); % Range of external magnetic field (0 to 10)
...
H_vals_back = linspace(3, -3, 5000); % Range of external magnetic field (10 to -10)
...
H_vals_forw = linspace(-3, 3, 5000); % Range of external magnetic field (10 to -10)
